              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600">+44 (0)7738 401449</p>
                  </div>
                </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="px-6 py-3 bg-blue-600 text-white font-medium rounded-md hover:bg-blue-700 transition-colors w-full md:w-auto"
